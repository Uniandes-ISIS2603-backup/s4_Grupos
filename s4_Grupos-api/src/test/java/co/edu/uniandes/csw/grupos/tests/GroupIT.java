...
public class GroupIT 
{
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "frontstepbystep-api.war")//War del modulo api
                ...
                .addPackage(CiudadanoDTO.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
    ...
    public void totalPeticiones(){
        Logger.getLogger(GroupIT.class.getName()).log(Level.INFO, "TOTAL-PETICIONES: {0}", sumaPeticiones);
    }   
}
