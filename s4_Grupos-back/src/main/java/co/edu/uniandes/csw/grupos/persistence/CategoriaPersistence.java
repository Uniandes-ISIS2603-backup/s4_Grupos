...
public class CategoriaPersistence {
     ...
     */
    public CategoriaEntity create(CategoriaEntity grupoEntity) {
     ...
     */
    public CategoriaEntity update(CategoriaEntity grupoEntity) {
    ...
    public void delete(Long grupoId) {
        ...
        CategoriaEntity grupoEntity = em.find(CategoriaEntity.class, grupoId);
